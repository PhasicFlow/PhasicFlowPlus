...
#include "Loth2008.hpp"
#include "unresolvedCouplingSystem.hpp"

pFlow::coupling::Loth2008::Loth2008
(
...
void pFlow::coupling::Loth2008::calculateLiftForce
(
...
) 
{
    ...
    for(size_t i=0; i<nPar; ++i)
    {
        ...
        (
            1 -
            ( 0.675 + 0.15 * (1 + Foam::tanh(0.28*(Rr-2))) ) *  Foam::tanh(0.18*Foam::sqrt(Rep))
        );
        ...
        {
            Cl_shear = - Foam::pow(Sr,0.3333)*(0.0525+0.0575*Foam::tanh(5*Foam::log10(Rep/120.0)));
        }
