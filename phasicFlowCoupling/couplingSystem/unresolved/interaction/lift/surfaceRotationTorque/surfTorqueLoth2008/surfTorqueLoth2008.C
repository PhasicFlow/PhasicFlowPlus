...
#include "surfTorqueLoth2008.hpp"
#include "lift.hpp"

pFlow::coupling::surfTorqueLoth2008::surfTorqueLoth2008
(
...
void pFlow::coupling::surfTorqueLoth2008::calculateSurfaceTorque
(
...
)
{
    ...
    for(size_t i=0; i<nPar; ++i)
    {
        ...
        const Foam::scalar f_shear = f_spin * (1-0.0075*Res)*(1-0.062*Foam::sqrt(Rep)-0.001*Rep);
