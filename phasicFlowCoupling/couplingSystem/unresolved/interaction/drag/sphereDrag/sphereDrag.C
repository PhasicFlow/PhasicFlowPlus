...
pFlow::coupling::sphereDrag<DragClosureType>::sphereDrag
(
...
template<typename DragClosureType>
void pFlow::coupling::sphereDrag<DragClosureType>::calculateDragForce
(
...
)
{
    ...
    for(size_t parIndx=0; parIndx<numPar; parIndx++)
    {
        ...
        Foam::scalar sp = 3 * Foam::constant::mathematical::pi * mui * ef * dp * dragClosure_.dimlessDrag(Re, ef);
