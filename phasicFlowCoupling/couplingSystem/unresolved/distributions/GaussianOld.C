...
void pFlow::coupling::GaussianOld::parseNeighbors(
...
void pFlow::coupling::GaussianOld::constructLists(const Foam::scalar searchLen)
{
...
pFlow::coupling::GaussianOld::GaussianOld
(
...
void pFlow::coupling::GaussianOld::updateWeights
(
