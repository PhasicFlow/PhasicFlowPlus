...
#define makeLaminarModel(Type)                                                 \
    ...
    (transportModelAlphaIncompressibleTurbulenceModel, laminar, Type)

#define makeRASModel(Type)                                                     \
    makeTemplatedTurbulenceModel                                               \
    (transportModelAlphaIncompressibleTurbulenceModel, RAS, Type)

#define makeLESModel(Type)                                                     \
    makeTemplatedTurbulenceModel                                               \
    (transportModelAlphaIncompressibleTurbulenceModel, LES, Type)
