...
<div align="center">
<b>
<img src="./Sand-Bridge.gif" alt="Sand-Bridge" style="width: 720px;"/>
</b>
<b>
...
1. Navigate to the `Sand Bridge` directory.
...
- `cellDistribution`: This part defines the method of distributing particle properties (like volume, drag force) across the cells. The options are:
  ...
  - `standardDeviation` : This parameter controls the strength of the diffusion process.
